...
* ruc_lazy_2_16_well, kept the bb tree node structure in the model, but quoted ruc_lazy.cpp is for lazy constraints implementation.
* ruc_backup_2_16_15, if something wrong, roll back version, 
*/
